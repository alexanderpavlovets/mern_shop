...
// fluid rounded - bootstrap take a look seems styles

// in subtotal card not everything so simple -we are able to modify qty due to From.control (qty) -> action -> reducer 